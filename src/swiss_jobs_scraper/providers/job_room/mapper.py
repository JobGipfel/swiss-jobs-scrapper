...
# This is a subset - full data would be loaded from bfs_codes.json
MAJOR_CITIES_BFS = {
    # Zürich Canton (ZH)
    "zurich": ["261"],
    "zürich": ["261"],
...
class BFSLocationMapper:
    ...
    def resolve(self, location: str) -> list[str]:
        ...
        # Try as postal code first (numeric check)
    ...
    def reverse_lookup(self, bfs_code: str) -> LocationInfo | None:
        ...
        """
        # Search through city cache
        for city, codes in self._city_cache.items():
            if bfs_code in codes:
                # Determine canton from common patterns
    ...
    def _guess_canton(self, bfs_code: str) -> str:
        ...
        # BFS code ranges by canton (approximate)
        if 1 <= code <= 300:
            return "ZH"
        elif 301 <= code <= 1000:
            return "BE"
    ...
    def get_canton_cities(self, canton_code: str) -> list[str]:
        ...
        # This would need enhanced data - stub for now
        return []
